  ...
  return (
    <div className='uk-section'>
      <Container>
        ...
        <p>In no event shall BrewBeer or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on BrewBeer's website, even if BrewBeer or a BrewBeer authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</p>
        <Header as='h2'>5. Accuracy of materials</Header>
        <p>The materials appearing on BrewBeer's website could include technical, typographical, or photographic errors. BrewBeer does not warrant that any of the materials on its website are accurate, complete or current. BrewBeer may make changes to the materials contained on its website at any time without notice. However BrewBeer does not make any commitment to update the materials.</p>
        <Header as='h2'>6. Links</Header>
        <p>BrewBeer has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by BrewBeer of the site. Use of any such linked website is at the user's own risk.</p>
        <Header as='h2'>7. Modifications</Header>
        <p>BrewBeer may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.</p>
        <Header as='h2'>8. Governing Law</Header>
        <p>These terms and conditions are governed by and construed in accordance with the laws of Ohio and you irrevocably submit to the exclusive jurisdiction of the courts in that State or location.</p>
      </Container>
    </div>
  );
}
