    ...
    return (
      <React.Fragment>
        ...
        <div className="main-container">
          <SideMenu id="side-menu" overlay={true} mode="slide" visible={this.state.showSideBar} onShow={this.showSideBar} onHide={this.hideSideBar}>
            <Nav>
              ...
              {(this.props.user.isAdmin || this.hasRole(user, ROLES.USER_MANAGER)) && (
                <React.Fragment>
              ...
              {(this.props.user.isAdmin || this.hasRole(user, ROLES.INGREDIENT_MANAGER)) && (
                <React.Fragment>
