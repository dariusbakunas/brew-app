    ...
    <div className='uk-section'>
      <Container>
        ...
        <p>
          ...
          Our Privacy Policy for BrewBeer is based on the Privacy Policy Template from
          Privacy Policies.
        </p>
        <p>
          ...
          meanings as in our Terms and Conditions, accessible from brew.geekspace.us</p>
        ...
        <p>
          BrewBeer will take all steps reasonably necessary to ensure that your data is
        ...
        <p>
          BrewBeer may disclose your Personal Data in the good faith belief that such action is
          necessary to:
        </p>
        <ul className='uk-list uk-list-bullet'>
