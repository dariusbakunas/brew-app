  ...
  return (
    <React.Fragment>
      {fermentables.map((fermentable) => (
        <FermentableInputRow fermentable={fermentable} key={fermentable.key} onChange={(f: IFermentable) => onUpdate(fermentable.key, f)} onRemove={() => onRemove(fermentable.key)} />
      ))}
      <div className="uk-margin-small-top">
        <Button onClick={onAdd} className="uk-button-small" variation="link">
          Add Fermentable
        </Button>
      </div>
    </React.Fragment>
